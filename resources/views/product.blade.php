      ...
      <div class="space-y-6">
        ...
        <div class="border border-dashed border-slate-200 bg-slate-50/50 p-4.5 rounded-xl space-y-4 text-xs font-semibold text-slate-700 leading-relaxed text-left">
          <div class="space-y-1">
            ...
            <p class="text-xs pl-6 text-slate-600 font-medium leading-normal">ঢাকার মধ্যে {{ $settings['shippingInsideDhaka'] ?? 60 }} টাকা, ঢাকার বাইরে {{ $settings['shippingOutsideDhaka'] ?? 130 }} টাকা!</p>
          </div>
          <div class="space-y-1">
            <p class="text-slate-900 font-bold text-sm flex items-center gap-1.5">💵 সম্পূর্ণ ক্যাশ অন ডেলিভারি:</p>
            <p class="text-xs pl-6 text-slate-600 font-medium leading-normal">অর্ডার করতে অগ্রিম ১ টাকাও দিতে হবেনা, পণ্য রিসিভ করার সময় টাকা পরিশোধ করবেন!</p>
          </div>
          <div class="space-y-1">
            <p class="text-slate-900 font-bold text-sm flex items-center gap-1.5">🔎 প্রোডাক্ট চেক করে নেওয়ার সুযোগ:</p>
            <p class="text-xs pl-6 text-slate-600 font-medium leading-normal">ডেলিভারি ম্যানের সামনে পণ্য ভালোভাবে দেখে তারপর রিসিভ করতে পারবেন।</p>
          </div>
        </div>
      </div>
    </div>
